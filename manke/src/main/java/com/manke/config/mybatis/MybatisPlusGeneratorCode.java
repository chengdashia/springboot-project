package com.manke.config.mybatis;
...
public class MybatisPlusGeneratorCode {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/manke?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8");
