...
public class FileInfoController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType="query",name="file",dataTypeClass = File.class,required=true,value="文件"),
            @ApiImplicitParam(paramType="query",name="labelList",dataTypeClass = List.class,required=true,value="标签列表")
    })
    public R<Object> uploadFile(
            @RequestParam("folder_id") @NotBlank(message = "父文件夹id不能为空") String folderId,
            @RequestParam("fileName") @NotBlank(message = "文件名字不能为空") String fileName,
            @RequestParam("remarks") @NotBlank(message = "文件名字不能为空") String remarks,
    ...
    public R<Object> updateFileName(
             ...
             @RequestParam("fileName") @NotBlank(message = "文件id不能为空") String fileName
    ){
