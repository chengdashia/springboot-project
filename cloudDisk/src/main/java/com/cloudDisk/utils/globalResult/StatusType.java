package com.cloudDisk.utils.globalResult;
...
public class StatusType {
    ...
    //图片上传问题
    public static final int FILE_UPLOAD_ERROR = -8;


    //图片格式问题
    public static final int FILE_TYPE_ERROR = -9;

    //图片上传成功
    public static final int FILE_UPLOAD_SUCCESS = -10;

    //文件夹为空
    public static final int FOLDER_EMPTY = -11;
