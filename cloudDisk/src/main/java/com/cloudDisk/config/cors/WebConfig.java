package com.cloudDisk.config.cors;

import cn.dev33.satoken.interceptor.SaAnnotationInterceptor;
import cn.dev33.satoken.interceptor.SaRouteInterceptor;
import cn.dev33.satoken.router.SaRouter;
import cn.dev33.satoken.stp.StpUtil;
import com.cloudDisk.config.interceptors.JWTInterceptor;
...
//
//            // 登录认证 -- 拦截所有路由，并排除/userInfo/loginByPassword 用于开放登录
////            SaRouter.match("/**", "/userInfo/loginByPassword","", r -> StpUtil.checkLogin());
//
//            SaRouter.match("/**")
...
//                    .notMatch("/fileInfo/getFIieRandom10")
//                    .notMatch("/fileInfo/getFIieTop10")
